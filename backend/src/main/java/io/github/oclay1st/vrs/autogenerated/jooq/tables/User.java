...
import io.github.oclay1st.vrs.autogenerated.jooq.tables.ArchivedVehicle.ArchivedVehiclePath;
import io.github.oclay1st.vrs.autogenerated.jooq.tables.Vehicle.VehiclePath;
...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> LAST_NAME = createField(DSL.name("last_name"), SQLDataType.VARCHAR(40).nullable(false), this, "");
     ...
     */
    public final TableField<UserRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    private transient ArchivedVehiclePath _archivedVehicle;

    /**
     * Get the implicit to-many join path to the <code>archived_vehicle</code>
     * table
     */
    public ArchivedVehiclePath archivedVehicle() {
        if (_archivedVehicle == null)
            _archivedVehicle = new ArchivedVehiclePath(this, null, Keys.ARCHIVED_VEHICLE_USER_ID_FK.getInverseKey());

        return _archivedVehicle;
    }

    private transient VehiclePath _vehicle;

    /**
     * Get the implicit to-many join path to the <code>vehicle</code> table
     */
    public VehiclePath vehicle() {
        if (_vehicle == null)
            _vehicle = new VehiclePath(this, null, Keys.VEHICLE_USER_ID_FK.getInverseKey());
