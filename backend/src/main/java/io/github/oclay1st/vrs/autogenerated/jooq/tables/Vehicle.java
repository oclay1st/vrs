...
public class Vehicle extends TableImpl<VehicleRecord> {
    ...
    /**
     * The column <code>vehicle.user_id</code>.
     */
    public final TableField<VehicleRecord, Long> USER_ID = createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<ForeignKey<VehicleRecord, ?>> getReferences() {
        return Arrays.asList(Keys.VEHICLE_USER_ID_FK);
    }
    ...
    public UserPath user() {
        if (_user == null)
            _user = new UserPath(this, Keys.VEHICLE_USER_ID_FK, null);
